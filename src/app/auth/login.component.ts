    ...
    <div class="grid md:grid-cols-2 gap-8">
      ...
      <div class="card">
        ...
        <form class="space-y-4" [formGroup]="form" (ngSubmit)="submit()">
          ...
          <button class="btn btn-primary" type="submit" [disabled]="form.invalid">Se connecter</button>
        </form>
      ...
      <div class="card">
        ...
        <p class="mt-2 text-gray-600">Connectez‑vous pour gérer vos locataires et répartir les factures (CIE, SODECI, Internet, etc.).</p>
